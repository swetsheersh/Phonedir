...
<html lang="en">
  ...
  <body style="background-color: LightGray">
    ...
    <div class="Container mt-0 " style="height:100%">
    	...
    	<h2 class="text-center">Find Your Loving One!!</h2>
			  <div class="container  bg-success mt-3 card mx-auto" style="width:80%">
			  	<div class="card-body">
			  		...
			  		<hr >
				    <form class="mt-5" action="searchsuccess" method="post">
    					<div class="form-group mt-5 text-white">
					      <label for="inputState">Search-By :</label>
					      <select id="inputState" class="form-control mt-2" name="select" required>

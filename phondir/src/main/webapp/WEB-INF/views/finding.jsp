...
<html lang="en">
  ...
  <body style="background-color: LightGray">
    ...
    <div class="Container mt-0 " style="height:100%">
    	...
    	<h2 class="text-center">Welcome!! to Search Section</h2>
			  <div class="container  bg-success mt-3 card mx-auto" style="width:95%">
			  	<div class="card-body">
			  		<h3 class="text-center text-white" style="text-transform:uppercase">Our Finding</h3>
			  		<hr >
			  ...
			  <div class="container mx-auto text-center">
				<a href="${pageContext.request.contextPath}/search" class="btn btn-outline-light mt-5">Back</a>
		    </div>
    	</div>
    </div>
    <div class="first container ">
		<div class="container bg-success p-2 text-white" style="width:81.7%">
